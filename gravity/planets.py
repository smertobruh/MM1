...
class PlanetMovement:
    """
    Класс хранения изменений в положении, скорости и ускорении планеты в заданном временном промежутке.
    """
    def __init__(self, 
                 dim : int, 
                 n : int, 
...
class PlanetEnergy:
    """
    Класс хранения изменений кинетической и потенциальной энергии планет.
    """
    def __init__(self, 
                 n : int):
        """
...
class Planet:
    """
    Класс хранения параметров планеты.
    """
    def __init__(self, 
                 m : float, 
                 dim : int, 
    ...
    @property
    def dist(self):
        return np.sqrt(self.movement.get_r(0)[0]**2 + self.movement.get_r(1)[0]**2 + self.movement.get_r(2)[0]**2)
